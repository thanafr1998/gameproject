...
public class Character {
	...
	public static final Image kickR2 = new Image(ClassLoader.getSystemResource("image/KICK_RIGHT_1.png").toString());
	...
	public static final Image RED_kickR2 = new Image(ClassLoader.getSystemResource("image/RED_KICK_RIGHT_1.png").toString());
	...
	public static final Image BLUE_kickR2 = new Image(ClassLoader.getSystemResource("image/BLUE_KICK_RIGHT_1.png").toString());
	...
	public static final Image GREY_kickR2 = new Image(ClassLoader.getSystemResource("image/GREY_KICK_RIGHT_1.png").toString());
}
